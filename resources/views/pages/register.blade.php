...
<body class="font-poppins">
    <div class="grid grid-cols-2">
        ...
        <div class="mx-[168px] flex flex-col items-center justify-center">
            <h1 class="text-[40px] font-semibold leading-[75px]">Buat akun LMS</h1>
            <div class="mt-[30px] w-full">
                <form action="">
                    ...
                    <div class="mt-[18px] flex items-center">
                        ...
                        <label for="" class="text-[15px] font-normal mt-1 ml-3 leading-[22.5px]">I agree with
                            LMS
                            policy</label>
                    </div>
                    ...
                    <div class="flex justify-center">
                        <button
                            class="bg-[#D9D9D9] w-[300px] h-14 mt-5 border border-[#000000] rounded-[10px]">Register</button>
                    </div>
                    ...
                    <div class="mt-[18px] flex items-center">
                        <button class="flex items-center border border-[#00000080] rounded-[10px] p-3 w-full">
                            <img src="/assets/images/google.png" width="40" height="40" class="ml-4"
                                alt="">
                            <span class="ml-5">Register using Google</span>
                        </button>
                    </div>
                    ...
                    <div class="mt-[18px] flex items-center">
                        <button class="flex items-center border border-[#00000080] rounded-[10px] p-3 w-full">
                            ...
                            <span class="ml-5">Register using Facebook</span>
                        </button>
                    </div>

                    <div class="flex justify-center mt-[18px]">
                        <span>Already have an account? <a href="/login"><u>Login</u></a></span>
                    </div>
                </form>
